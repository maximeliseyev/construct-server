...
use test_utils::{spawn_app, TestUser};
...
async fn test_get_public_key_returns_target_user_not_requester() {
    ...
    println!("✅ Kim registered with identity key: {}...", &kim_identity_b64[..20]);
    println!("✅ Max registered with identity key: {}...", &max_identity_b64[..20]);
    ...
    let kim_bundle_data_bytes = general_purpose::STANDARD.decode(kim_bundle_data_b64).unwrap();
